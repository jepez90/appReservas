                ...
                if (link.nodeName == "A") {
                    if (link.getAttribute("data-app-accion") == 1) {//nueva cita a la misma hora
                        ...
                        link.onclick = function (e) {
                            ...
                            $.post("Gestion", {"accion": 4, "IdReserva": e.target.parentNode.previousElementSibling.getAttribute("data-app-id")}, $.proxy(function (result, status) {
...
function Form() {
    ...
    this.FieldHoraAC = this.FieldHora.autocomplete({
        ...
        onSearchStart: $.proxy(function () {
            this.setEstado("Hora", "Loading")
        }, this),
    ...
    this.FieldPlacaNuevaAC = this.FieldPlacaNueva.autocomplete({
        ...
        onSearchStart: $.proxy(function () {
            this.setEstado("PlacaNueva", "Loading")
        }, this),
        onSearchComplete: $.proxy(function (query, suggestions) {
    ...
    this.FieldCedula.focus($.proxy(function () {
        this.ACCedula_FieldSelectId = "Cedula";
    }, this));
    this.FieldCedulaC.focus($.proxy(function () {
        this.ACCedula_FieldSelectId = "CedulaC";
    }, this));
    ...
    $("#Cedula,#CedulaC").autocomplete({
        ...
        type: "post",
        onSearchStart: $.proxy(function (params) {
            this.setEstado(this.ACCedula_FieldSelectId, "Loading");
        }, this),
        onSearchComplete: $.proxy(function (query, suggestions) {
...
Form.prototype.ActivaFecha = function (estado) {
    if (estado == true) {
        ...
        this.SelectorDeFecha.on("open", $.proxy(function (e) {
            this.SelectorDeFecha.close();
        }, this));
