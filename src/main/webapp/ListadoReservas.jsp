...
<!-- 				<input type="hidden"  name="accion" id="accion" value="0"> -->
	...
	<div class="justify-content-center form-inline">
		    ...
		    <input type="checkbox" class="custom-control-input" id="mostrarPendientes" <%if(mostrarPendientes){%>checked<% } %>>
		    <label class="custom-control-label" for="mostrarPendientes">Mostras solo los Pendientes</label>
		  </div>
		  <button type="button"  id="addBtn" class="btn btn-outline-success btn-sm"  data-toggle="modal" data-target="#myModal"  data-app-hora=""   style="padding:1px; width:200px;">
		...
		<div class="table-responsive">
			...
			<% int i=0; for (Reserva r:reservas){ i++;
